...
//			boFile.transferTo(new File("/home/pc11/upload/abc.zip"));
			// transferTo는 폴더가 존재하지 않으면 오류 발생해서 FileUtil을 썼었으나
			// .. 지금은 버전업되어서 파일 자동 생성됨 
			boFile.transferTo(new File("/home/pc11/upload/2020/09/15/abc.zip"));
			// transferTo안될 때 이렇게 썼었음 ↓
//			FileUtils.copyInputStreamToFile(boFile.getInputStream(), new File("/home/pc11/upload/2020/09/15/def.zip"));
		}
		// 테스트이므로 입력폼으로 리다이렉트
