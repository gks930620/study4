      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          %>
            ...
            <li class="dropdown">
              <button type="button" class="dropdown-toggle btn btn-lg btn-warning" data-toggle="dropdown" role="button" aria-expanded="false"><%=user.getUserName()%>님 <span class="caret"></span></button>
              <ul class="dropdown-menu" role="menu">
